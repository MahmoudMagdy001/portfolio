...
const sectionIds: readonly string[] = ['beginning', 'journey', 'projects', 'services', 'skills', 'contact'];
...
const Navbar: FC = () => {
  ...
  const { ref: logoRef, x: logoX, y: logoY } = useMagneticEffect<HTMLAnchorElement>(0.25);
  const { ref: hireRef, x: hireX, y: hireY } = useMagneticEffect<HTMLAnchorElement>(0.2);
