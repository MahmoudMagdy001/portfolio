...
const BeginningDesktop = () => {
  ...
  // --- Paragraph 0 (i=0, range 0.00 → 0.25) — full range anchored to prevent extrapolation ---
  const p0Opacity = useTransform(scrollYProgress, [0, 0.24, 0.25, 1.0], [1, 1, 0, 0]);
  ...
  const p1Opacity = useTransform(scrollYProgress, [0, 0.25, 0.30, 0.45, 0.50, 1.0], [0, 0, 1, 1, 0, 0]);
  ...
  const p2Opacity = useTransform(scrollYProgress, [0, 0.50, 0.55, 0.70, 0.75, 1.0], [0, 0, 1, 1, 0, 0]);
  ...
  const p3Opacity = useTransform(scrollYProgress, [0, 0.75, 0.80, 0.95, 1.00], [0, 0, 1, 1, 0]);
